...
#
# Environment contract (the same one CausewaybayWallet uses, so a single exported set
...
# notarized, stapled .dmg is the only way around that, and a server binary handed
