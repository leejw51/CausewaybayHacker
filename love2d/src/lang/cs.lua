...
return {
  ...
  ["the brief"] = "zadání",
  ["the output"] = "výstup",
  ["the question and your code, copied"] = "zadání a kód zkopírovány",
  ["COPY Q+CODE"] = "KOPÍROVAT ZADÁNÍ+KÓD",
  ["API KEY"] = "API KLÍČ",
  ["AUTO"] = "AUTOM.",
  ["AUTO lets the coder review your code by itself, now and then. It spends a call when it does."] = "S AUTO si kodér tvůj kód občas přečte sám. Pokaždé to stojí jedno volání.",
  ["BACK"] = "ZPĚT",
  ["CLEAR"] = "VYMAZAT",
  ["CLOSE"] = "ZAVŘÍT",
  ["CODER"] = "KODÉR",
  ...
  ["EDIT"] = "UPRAVIT",
  ["HOST"] = "ADRESA",
  ["Holding still. Touch anywhere else and I'll roam."] = "Stojím. Klepni jinam a zase poletím.",
  ["IMAGE"] = "OBRÁZEK",
  ["Kept on this machine only, and sent to the provider that issued it. Never to the game server."] = "Zůstává jen na tomto počítači a odchází jen k providerovi, který ho vydal. Nikdy na herní server.",
  ["MODEL"] = "MODEL",
  ["MODELS"] = "MODELY",
  ["Nothing said yet. Ask about the code, or type a brief and press WRITE."] = "Zatím nic. Zeptej se na kód, nebo napiš zadání a stiskni WRITE.",
  ["OFF"] = "VYP",
  ["ON"] = "ZAP",
  ["PROBLEM"] = "PROBLÉM",
  ["REVIEW"] = "REVIZE",
  ["RUST CODER"] = "RUST KODÉR",
  ["Review this program. Be concrete and brief."] = "Projdi tenhle program. Konkrétně a stručně.",
  ["SEND"] = "POSLAT",
  ["SETUP"] = "NASTAVENÍ",
  ["STOP"] = "ZASTAVIT",
  ["TOOL"] = "NÁSTROJ",
  ...
  ["YOU"] = "TY",
  ["[picture]"] = "[obrázek]",
  ["ask the coder, or say what to write…"] = "zeptej se kodéra, nebo řekni, co napsat…",
  ["asking…"] = "ptám se…",
  ...
  ["no key yet — press here and paste"] = "zatím žádný klíč — klepni sem a vlož",
  ...
  ["still working — press STOP first"] = "ještě pracuje — nejdřív stiskni STOP",
  ["stopped"] = "zastaveno",
  ...
  ["LV %d · %d XP"] = "ÚROVEŇ %d · %d XP",
  ["PRACTICE +%d XP"] = "CVIČENÍ +%d XP",
  ["CLEARED · PRACTISED ×%d"] = "VYČIŠTĚNO · CVIČENO ×%d",
  ["+%d XP"] = "+%d bodů XP",
  ...
  ["%d/%d CLEARED · %d%%"] = "%d/%d HOTOVO · %d%%",
  ["%d ATTEMPTS"] = "%d pokusů",
  ["%d samples"] = "%d ukázek",
  ["+%d hidden"] = "+%d skrytých",
  ["all cases"] = "všechny případy",
  ["SUGGESTED AFTER %s"] = "DOPORUČENO PO %s",
  ["drill: %s"] = "trénink: %s",  -- UNREVIEWED: same
  ...
  ["ARROWS choose   ENTER go   P playground   ESC back"] = "ŠIPKY výběr   ENTER dál   P hřiště   ESC zpět",
  ...
  ["not saved — the disk did not read back"] = "neuloženo — desku nešlo přečíst zpět",
  ["could not make the poster"] = "plakát se nepodařilo vytvořit",
  ["drop a poster on the window, or type its path and press ENTER"] = "přetáhněte plakát do okna, nebo napište cestu a stiskněte ENTER",
  ["disk read · written and signed by %s · verified"] = "deska přečtena · napsal a podepsal %s · ověřeno",
  ["disk read · the signature does NOT match %s"] = "deska přečtena · podpis NEODPOVÍDÁ %s",
  ["disk read · unsigned · claims %s"] = "deska přečtena · bez podpisu · hlásí se k %s",
  ["the label holds only the hash — the code is on the disc, not the label"] = "štítek nese jen hash — kód je na desce, ne na štítku",
  ["no disk on that picture"] = "na tom obrázku není deska",
  ["could not read that file"] = "ten soubor se nepodařilo přečíst",
  ...
  ["%s goes back to untouched — %d of %d streets lose their stamp and stars, and every editor on the road goes back to its starter. Your XP and your mistakes are kept, and clearing them again pays no XP."] = "%s se vrátí na začátek — %d z %d ulic přijde o razítko a hvězdy a každý editor na cestě se vrátí ke svému startovnímu kódu. XP a chyby zůstanou a další vyčištění už XP nepřinese.",
  ["RESET IT"] = "VYNULOVAT",
